...
public class Arvore {
    ...
    /*    int N = 3000;
        ...
        // NA LINHA ABAIXO, � EXIBIDO O N�MERO DE N�VEIS, UTILIZADO O M�TODO contaNiveis QUE RETORNA O NUMERO DE NIVEIS DE UMA ARVORE (OU SUB-ARVORE) EM QUE O ELEMENTO RA�Z � PASSADO POR PARAMETRO
        // System.out.println(contaNiveis(inicio)+" n�veis");
        
        // NA LINHA ABAIXO, � EXIBIDO O N�MERO DE FOLHAS, UTILIZADO O M�TODO contaFolhas QUE RETORNA O NUMERO DE FOLHAS DE UMA ARVORE (OU SUB-ARVORE) EM QUE O ELEMENTO RA�Z � PASSADO POR PARAMETRO
        //System.out.println(contaFolhas(inicio)+" folhas");
        
        
        // O M�TODO ABAIXO REMOVE TODAS AS FOLHAS DE UMA �RVORE EM QUE O ELEMENTO RA�Z � PASSADO POR PARAMETRO
        //removeFolhas(inicio);
        ...
        */
        ...
        //conta n�veis
        //System.out.println("\n �rvore com "+contaNiveis(inicio)+" N�veis");
        
        //conta folhas
        // System.out.println("\n �rvore com "+contaFolhas(inicio)+" Folhas");
   ...
   // ESSE METODO EXISTE EXCLUISIVAMENTE PARA VERIFICAR SE O VALOR A SER REMOVIDO ESTA NA RAIZ DA ARVORE (inicio)
    ...
    static void removeNo(No n, int x){
        ...
        switch(f){
			case -1: System.out.println("O n� n�o existe na �rvore"); break;
	...
	// ESSE M�TODO REMOVE TODAS AS FOLHAS EXISTENTES NA �RVORE ATUAL (NOTE QUE A REMO��O DE FOLHAS IR� GERAR UMA NOVA �RVORE COM OUTRAS FOLHAS) 
	...
	// M�TODO QUE VERIFICA SE UM N� TEM FILHOS OU N�O
